...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout','data' => ['title' => 'Autenticacion']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Autenticacion')]); ?>
    ...
    <a class="card-link-wrapper" href="<?php echo e(url('api/autenticacion')); ?>">
        <section class="card-info">
    ...
    <a class="card-link-wrapper" href="<?php echo e(url('api/autenticacion/1')); ?>">
        <section class="card-info">
...
<?php endif; ?><?php /**PATH F:\Dev\Backend_Solunissi\resources\views/autenticación.blade.php ENDPATH**/ ?>